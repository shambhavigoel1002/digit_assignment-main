...
abstract class $RoleCopyWith<$Res> {
  ...
  @useResult
  $Res call({dynamic tenantId, dynamic name});
}
...
class _$RoleImpl implements _Role {
  const _$RoleImpl({required this.tenantId, this.name});
...
abstract class _Role implements Role {
  const factory _Role({required final dynamic tenantId, final dynamic name}) =
      _$RoleImpl;
